...
//-----------------------------------------------------------------------------
{
    ...
    /*
      float data1[] =
      {0,3,1,-3,-3,-4,-1,-2,-4,-1,-3,-5,2,-1,-3,3,1,-1,-3,0,3,-3,1,2,0,-1,-1};
      float data2[] = {5,5,6, 10,12,13, 20,19,17, -4,-3,2, 1,-1,0, 10,8,5,
      7,14,14, -2,3,-1, -1,-2,-2 };
...
//-----------------------------------------------------------------------------
{
  ...
  GLUI_Master.get_viewport_area( viewport + 0, viewport + 1, viewport + 2,
viewport + 3 );
  ...
  gl2psBeginPage ( out_filename->get_text(), "Topological Marching Cubes (by
Thomas Lewiner)", viewport_gl,
